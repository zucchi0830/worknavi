...
if (empty($errors)) {
    ...
    header('Location: job_signup_confirm.php');
    exit;
    }
}
        ...
        <form class="signup_form" action="" method="post">
            ...
            <label class="transfer_label signup_label" for="transfer">転勤の可能性<span class="asterisk">*</span></label>
                <?php foreach ($sel_ornot as $transfer_value) : ?>
                    ...
                    <?php else : ?>
                        <!-- ② POST データが存在しない場合はこちらの分岐に入る -->
                        <?= "<input type='radio' name='transfer' value='$transfer_value' id='$transfer_value'>" . "<label for='$transfer_value'>" . $transfer_value . "</label>" ?>                    <?php endif; ?>
                <?php endforeach; ?>
            ...
            <label class="upload_content_label" id="preview" for="file_upload">
                ...
                <span id="upload_text" class="upload_text">会社の就業風景・写真・ロゴなどを添付してください</span>
            </label>
