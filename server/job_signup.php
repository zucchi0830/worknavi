...
<body>
    ...
    <section class="job_signup_content wrapper">
        ...
        <form class="signup_form" action="" method="post">
            ...
            <input type="radio" name="commute" value="可(駐車場有)"> 可(駐車場有)
            <input type="radio" name="commute" value="可(駐車場無)"> 可(駐車場無)
            <input type="radio" name="commute" value="バイク可"> バイク可
            <input type="radio" name="commute" value="不可"> 不可
