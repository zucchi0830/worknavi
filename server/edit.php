        ...
        <form class="signup_form" action="" method="post">
            ...
            <select name="j_address_prefectures" id="j_address_prefectures">
                <?php foreach ($sel_address_prefectures as $j_address_prefectures_value) : ?>
                    <?php if ($j_address_prefectures_value === $job['j_address_prefectures']) : ?>
                        <!-- ① POST データが存在する場合はこちらの分岐に入る -->
                        <?= "<option value=" . $job['j_address_prefectures'] . " selected>" . $j_address_prefectures_value . "</option>" ?>
                    <?php else : ?>
                        <!-- ② POST データが存在しない場合はこちらの分岐に入る -->
                        <?= "<option value=" . $job['j_address_prefectures'] . ">" . $j_address_prefectures_value . "</option>" ?>
                    <?php endif; ?>
                <?php endforeach; ?>
            </select>

            <label class="j_address_detail_label signup_label" for="j_address_detail">勤務地 市区町村番地 建物名<span class="asterisk">*</span></label>
            <input type="text" name="j_address_detail" id="j_address_detail" placeholder="建物名まで" value="<?= h($job['j_address_detail']) ?>">
            ...
            <label class="employment_label signup_label" for="employment">雇用形態<span class="asterisk">*</span></label>
                <?php foreach ($sel_employment as $employment_value) : ?>
                    <?php if ($employment_value === $job['employment']) : ?>
                        <!-- ① POST データが存在する場合はこちらの分岐に入る -->
                        <?= "<input type='radio' name='employment' value=" . $job['employment'] . " " . "id='$employment_value' checked>" . "<label for='$employment_value'>" . $employment_value . "</label>" ?>
                    <?php else : ?>
                        <!-- ② POST データが存在しない場合はこちらの分岐に入る -->
                        <?= "<input type='radio' name='employment' value=" . $job['employment'] . " " . "id='$employment_value'>" . "<label for='$employment_value'>" . $employment_value . "</label>" ?>
                    <?php endif; ?>
                <?php endforeach; ?>
            ...
            <label class="smoke_label  signup_label" for="smoke">受動喫煙防止対策<span class="asterisk">*</span></label>
                <?php foreach ($sel_smoke as $smoke_value) : ?>
                    <?php if ($smoke_value === $job['smoke']) : ?>
                        <!-- ① POST データが存在する場合はこちらの分岐に入る -->
                        <?= "<input type='radio' name='smoke' value=" . $job['smoke'] . " " . "id='$smoke_value' checked>" . "<label for='$smoke_value'>" . $smoke_value . "</label>" ?>
                    <?php else : ?>
                        <!-- ② POST データが存在しない場合はこちらの分岐に入る -->
                        <?= "<input type='radio' name='smoke' value=" . $job['smoke'] . " " . "id='$smoke_value'>" . "<label for='$smoke_value'>" . $smoke_value . "</label>" ?>
                    <?php endif; ?>
                <?php endforeach; ?>
            ...
            <label class="commuten_label  signup_label" for="commute">マイカー通勤<span class="asterisk">*</span></label>
                <?php foreach ($sel_commute as $commute_value) : ?>
                    <?php if ($commute_value === $job['commute']) : ?>
                        <!-- ① POST データが存在する場合はこちらの分岐に入る -->
                        <?= "<input type='radio' name='commute' value=" . $job['commute'] . " " . "id='$commute_value' checked>" . "<label for='$commute_value'>" . $commute_value . "</label>" ?>
                    <?php else : ?>
                        <!-- ② POST データが存在しない場合はこちらの分岐に入る -->
                        <?= "<input type='radio' name='commute' value=" . $job['commute'] . " " . "id='$commute_value' >" . "<label for='$commute_value'>" . $commute_value . "</label>" ?>
                    <?php endif; ?>
                <?php endforeach; ?>
            ...
            <label class="transfer_label signup_label" for="transfer">転勤の可能性<span class="asterisk">*</span></label>
                <?php foreach ($sel_ornot as $transfer_value) : ?>
                    <?php if ($transfer_value === $job['transfer']) : ?>
                        <!-- ① POST データが存在する場合はこちらの分岐に入る -->
                        <?= "<input type='radio' name='transfer' value=" . $job['transfer'] . " " . "id='$transfer_value' checked>" . "<label for='$transfer_value'>" . $transfer_value . "</label>" ?>
                    <?php else : ?>
                        <!-- ② POST データが存在しない場合はこちらの分岐に入る -->
                        <?= "<input type='radio' name='transfer' value=" . $job['transfer'] . " " . "id='$transfer_value'>" . "<label for='$transfer_value'>" . $transfer_value . "</label>" ?>                    <?php endif; ?>
                <?php endforeach; ?>
            ...
            <label class="academic_label signup_label" for="academic">必要学歴<span class="asterisk">*</span></label>
                <?php foreach ($sel_academic as $academic_value) : ?>
                    <?php if ($academic_value === $job['academic']) : ?>
                        <!-- ① POST データが存在する場合はこちらの分岐に入る -->
                        <?= "<input type='radio' name='academic' value=" . $job['academic'] . " " . "id='$academic_value' checked>" . "<label for='$academic_value'>" . $academic_value . "</label>" ?>
                    <?php else : ?>
                        <!-- ② POST データが存在しない場合はこちらの分岐に入る -->
                        <?= "<input type='radio' name='academic' value=" . $job['academic'] . " " . "id='$academic_value'>" . "<label for='$academic_value'>" . $academic_value . "</label>" ?>
                    <?php endif; ?>
                <?php endforeach; ?>
            ...
            <label class="allowance_label signup_label" for="allowance">通勤手当有無<span class="asterisk">*</span></label>
                <?php foreach ($sel_ornot as $allowance_value) : ?>
                    <?php if ($allowance_value === $job['allowance']) : ?>
                        <!-- ① POST データが存在する場合はこちらの分岐に入る -->
                        <?= "<input type='radio' name='allowance' value=" . $job['allowance'] . " " . "id='$allowance_value' checked>" . "<label for='$allowance_value'>" . $allowance_value . "</label>" ?>
                    <?php else : ?>
                        <!-- ② POST データが存在しない場合はこちらの分岐に入る -->
                        <?= "<input type='radio' name='allowance' value=" . $job['allowance'] . " " . "id='$allowance_value'>" . "<label for='$allowance_value'>" . $allowance_value . "</label>" ?>
                    <?php endif; ?>
                <?php endforeach; ?>
            ...
            <?php if ( $sel_insurances[1] == $job['insurance1']) : ?>
                <!-- ① POST データが存在する場合はこちらの分岐に入る -->
                <?= "<input type='checkbox' name='insurance1' value=" . $job['insurance1'] . " " . "id='$sel_insurances[1]' checked>" . "<label for='$sel_insurances[1]'>" . "$sel_insurances[1]". "</label>" ?>
            <?php else : ?>
                <!-- ② POST データが存在しない場合はこちらの分岐に入る -->
                <?= "<input type='checkbox' name='insurance1' value=" . $job['insurance1'] . " " . "id='$sel_insurances[1]'>" . "<label for='$sel_insurances[1]'>" . "$sel_insurances[1]". "</label>" ?>
            <?php endif; ?>
            <?php if ( $sel_insurances[2] == $job['insurance2']) : ?>
                <!-- ① POST データが存在する場合はこちらの分岐に入る -->
                <?= "<input type='checkbox' name='insurance2' value=" . $job['insurance2'] . " " . "id='$sel_insurances[2]' checked>" . "<label for='$sel_insurances[2]'>" . "$sel_insurances[2]". "</label>" ?>
            <?php else : ?>
                <!-- ② POST データが存在しない場合はこちらの分岐に入る -->
                <?= "<input type='checkbox' name='insurance2' value=" . $job['insurance2'] . " " . "id='$sel_insurances[2]'>" . "<label for='$sel_insurances[2]'>" . "$sel_insurances[2]". "</label>" ?>
            <?php endif; ?>
            <?php if ( $sel_insurances[3] == $job['insurance3']) : ?>
                <!-- ① POST データが存在する場合はこちらの分岐に入る -->
                <?= "<input type='checkbox' name='insurance3' value=" . $job['insurance3'] . " " . "id='$sel_insurances[3]' checked>" . "<label for='$sel_insurances[3]'>" . "$sel_insurances[3]". "</label>" ?>
            <?php else : ?>
                <!-- ② POST データが存在しない場合はこちらの分岐に入る -->
                <?= "<input type='checkbox' name='insurance3' value=" . $job['insurance3'] . " " . "id='$sel_insurances[3]'>" . "<label for='$sel_insurances[3]'>" . "$sel_insurances[3]". "</label>" ?>
            <?php endif; ?>
            <?php if ( $sel_insurances[4] == $job['insurance4']) : ?>
                <!-- ① POST データが存在する場合はこちらの分岐に入る -->
                <?= "<input type='checkbox' name='insurance4' value=" . $job['insurance4'] . " " . "id='$sel_insurances[4]' checked>" . "<label for='$sel_insurances[4]'>" . "$sel_insurances[4]". "</label>" ?>
            <?php else : ?>
                <!-- ② POST データが存在しない場合はこちらの分岐に入る -->
                <?= "<input type='checkbox' name='insurance4' value=" . $job['insurance4'] . " " . "id='$sel_insurances[4]'>" . "<label for='$sel_insurances[4]'>" . "$sel_insurances[4]". "</label>" ?>
            <?php endif; ?>
            ...
            <label class="childcare_leave_label  signup_label" for="childcare_leave">育休の取得実績<span class="asterisk">*</span></label>
                <?php foreach ($sel_ornot as $childcare_leave_value) : ?>
                    <?php if ($childcare_leave_value === $job['childcare_leave']) : ?>
                        <!-- ① POST データが存在する場合はこちらの分岐に入る -->
                        <?= "<input type='radio' name='childcare_leave' value=" . $job['childcare_leave'] . " " . "id='$childcare_leave_value' checked>" . "<label for='$childcare_leave_value'>" . $childcare_leave_value . "</label>" ?>
                    <?php else : ?>
                        <!-- ② POST データが存在しない場合はこちらの分岐に入る -->
                        <?= "<input type='radio' name='childcare_leave' value=" . $job['childcare_leave'] . " " . "id='$childcare_leave_value'>" . "<label for='$childcare_leave_value'>" . $childcare_leave_value . "</label>" ?>
                    <?php endif; ?>
                <?php endforeach; ?>
            ...
            <label class="retirement_label signup_label" for="retirement">定年制度<span class="asterisk">*</span></label>
                <?php foreach ($sel_ornot as $retirement_value) : ?>
                    <?php if ($retirement_value === $job['retirement']) : ?>
                        <!-- ① POST データが存在する場合はこちらの分岐に入る -->
                        <?= "<input type='radio' name='retirement' value=" . $job['retirement'] . " " . "id='$retirement_value' checked>" . "<label for='$retirement_value'>" . $retirement_value . "</label>" ?>
                    <?php else : ?>
                        <!-- ② POST データが存在しない場合はこちらの分岐に入る -->
                        <?= "<input type='radio' name='retirement' value=" . $job['retirement'] . " " . "id='$retirement_value'>" . "<label for='$retirement_value'>" . $retirement_value . "</label>" ?>
                    <?php endif; ?>
                <?php endforeach; ?>
            ...
            <label class="rehire_label signup_label" for="rehire">再雇用制度<span class="asterisk">*</span></label>
                <?php foreach ($sel_ornot as $rehire_value) : ?>
                    <?php if ($rehire_value === $job['rehire']) : ?>
                        <!-- ① POST データが存在する場合はこちらの分岐に入る -->
                        <?= "<input type='radio' name='rehire' value=" . $job['rehire'] . " " . "id='$rehire_value' checked>" . "<label for='$rehire_value'>" . $rehire_value . "</label>" ?>
                    <?php else : ?>
                        <!-- ② POST データが存在しない場合はこちらの分岐に入る -->
                        <?= "<input type='radio' name='rehire' value=" . $job['rehire'] . " " . "id='$rehire_value'>" . "<label for='$rehire_value'>" . $rehire_value . "</label>"?>
                    <?php endif; ?>
                <?php endforeach; ?>
            ...
            <label class="trial_period_label signup_label" for="trial_period">試用期間有無<span class="asterisk">*</span></label>
                <?php foreach ($sel_ornot as $trial_period_value) : ?>
                    <?php if ($trial_period_value === $job['trial_period']) : ?>
                        <!-- ① POST データが存在する場合はこちらの分岐に入る -->
                        <?= "<input type='radio' name='trial_period' value=" . $job['trial_period'] . " " . "id='$trial_period_value' checked>" . "<label for='$trial_period_value'>" . $trial_period_value . "</label>" ?>
                    <?php else : ?>
                        <!-- ② POST データが存在しない場合はこちらの分岐に入る -->
                        <?= "<input type='radio' name='trial_period' value=" . $job['trial_period'] . " " . "id='$trial_period_value'>" . "<label for='$trial_period_value'>" . $trial_period_value . "</label>" ?>
                    <?php endif; ?>
                <?php endforeach; ?>
            ...
            <label class="trial_period_conditions_label signup_label" for="trial_period_conditions">試用期間中の労働条件相違<span class="asterisk">*</span></label>
                <?php foreach ($sel_ornot as $trial_period_conditions_value) : ?>
                    <?php if ($trial_period_conditions_value === $job['trial_period_conditions']) : ?>
                        <!-- ① POST データが存在する場合はこちらの分岐に入る -->
                        <?= "<input type='radio' name='trial_period_conditions' value=" . $job['trial_period_conditions'] . " " . "id='$trial_period_conditions_value' checked>" . "<label for='$trial_period_conditions_value'>" . $trial_period_conditions_value . "</label>" ?>
                    <?php else : ?>
                        <!-- ② POST データが存在しない場合はこちらの分岐に入る -->
                        <?= "<input type='radio' name='trial_period_conditions' value=" . $job['trial_period_conditions'] . " " . "id='$trial_period_conditions_value'>" . "<label for='$trial_period_conditions_value'>" . $trial_period_conditions_value . "</label>" ?>
                    <?php endif; ?>
                <?php endforeach; ?>
